...
<section class="section-pages">
    <div class="pages-wrapper">
        ...
        <form action="<?= base_url('tambah-alamat') ?>" method="POST">
            <?= csrf_field() ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="alamatLengkap" name="alamatLengkap" rows="3" value="<?= $user_data['alamat_jalan'] ?>" placeholder="Format: Nama Jalan, No. Rumah, RT/RW, Kelurahan, Kecamatan, Kota, Kode Pos" required=""></textarea>
                    </div>
                </div>
            </div>
            <button class="btn btn-dark mt-3 form-control"><i class="bx bxs-save"></i> Tambah</button>
        </form>
    </div>
</section>
<?= $this->endSection() ?>